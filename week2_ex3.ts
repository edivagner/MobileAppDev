...
const salary: number[] = [10000, 24000, 44000, 70000];


function salaryCalc(valCalc: number[]): void {

    for (let index = 0; index < valCalc.length; index++) {
        const element = valCalc[index];
