...
let daysWeek: string[] = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];

daysWeek.forEach(function (element: any) {
    console.log(element);
});
...
let spliceNumbers = numbers.splice(1, 2);
...
let daysWeekC: string[] = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];

let map1 = daysWeekC.map(element => element.length);
console.log(map1);